 ...
 */
class SectorAdapter(context: Context?, resource: Int, objects: List<ChamaSector>?) : ArrayAdapter<ChamaSector>(context, resource, objects) {
    ...
    override fun getItemId(position: Int): Long {
        return getItem(position).sectorId!!.toLong()
    }
}
