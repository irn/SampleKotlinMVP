...
import kotlinx.android.synthetic.main.fragment_transaction_out.*
 ...
 *
 */
class TransactionOutFragment : BaseContributionFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.getMembersOfGroup(viewModel.currentPlan.group?.groupId!!).observe(this, Observer {
            membersList = it as java.util.ArrayList<ChamaMember>
